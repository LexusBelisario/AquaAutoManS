...
void loop()
{
  ...
  float dissolvedOxygen = readDO(ADC_Voltage, Temperaturet) / 1000.0;

  // Print the dissolved oxygen value
  Serial.print(String(dissolvedOxygen, 2));

  Serial.print(" ");

  // Print the oxygen level classification
  if (dissolvedOxygen == 0) {
    ...
    Serial.println("Normal Oxygen");
  } 
  else if (dissolvedOxygen > 5) {
    Serial.println("High Oxygen");
  }
